...
export function PageNotFound() {
    return (
        <DeepVoidBackground className="flex items-center justify-center text-center p-4">
            <div className="bg-bg-surface-base border border-metroll-primary/20 p-8 rounded-lg max-w-md w-full relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col items-center gap-6">
                    ...
                    <p className="text-sm text-text-content-tertiary font-mono leading-relaxed">
                    ...
                    <a
                        href="/"
                        className="flex items-center gap-2 px-6 py-3 bg-metroll-primary text-black font-bold text-sm uppercase tracking-widest rounded hover:bg-yellow-400 transition-all shadow-neon hover:shadow-[0_0_20px_rgba(240,185,11,0.4)] group mt-4"
                    >
                        <Home size={16} />
