    ...
    <DeepVoidBackground className="py-8" disableAnimation>
      <div className="w-full px-4 md:px-8 space-y-8 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-white/10 pb-6">
          <div className="flex items-center gap-4">
            <div className="relative group">
              <div className="absolute -inset-1 bg-metroll-primary/20 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-500"></div>
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl flex items-center justify-center bg-black border border-metroll-primary/30 text-metroll-primary relative z-10 shadow-[0_0_15px_rgba(240,185,11,0.1)]">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold font-mono tracking-tight text-white flex items-center gap-3 uppercase">
                ...
                <span className="text-xs font-mono font-normal px-2 py-0.5 rounded bg-metroll-primary/10 text-metroll-primary border border-metroll-primary/20 tracking-wider">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* AI Models Card */}
          <div className="card rounded-lg border border-white/5 overflow-hidden">
            <div className="px-4 py-3 border-b border-white/5 bg-black/20 flex items-center gap-2 backdrop-blur-sm">
              <Brain className="w-4 h-4 text-metroll-primary" />
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <div className="font-mono text-sm text-zinc-200 group-hover:text-metroll-primary transition-colors">
          ...
          <div className="card rounded-lg border border-white/5 overflow-hidden">
            <div className="px-4 py-3 border-b border-white/5 bg-black/20 flex items-center gap-2 backdrop-blur-sm">
              <Landmark className="w-4 h-4 text-metroll-primary" />
              <h3 className="text-sm font-mono tracking-widest text-zinc-300 uppercase">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="font-mono text-sm text-zinc-200 group-hover:text-metroll-primary transition-colors truncate">
                        ...
                        return (
                          <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                            ...
                            <button
                              ...
                              className="text-zinc-600 hover:text-metroll-primary"
                            >
