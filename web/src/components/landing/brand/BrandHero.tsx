...
export default function BrandHero() {
    ...
    return (
        <section className="relative w-full min-h-screen bg-bg-surface-base text-text-content-primary overflow-hidden flex flex-col pt-16">

            {/* Top Marquee */}
            <div className="w-full bg-metroll-primary text-black font-bold py-2 border-y border-black z-20">
                <Marquee speed={40}>
            ...
            <div className="flex flex-col lg:flex-row flex-1 relative z-10">
                ...
                <div className="flex-1 flex flex-col justify-center px-6 lg:px-16 pt-12 lg:pt-0 relative z-20">
                    ...
                    >
                        <h1 className="text-6xl md:text-8xl lg:text-[7rem] font-black leading-[0.9] tracking-tighter mb-6">
                            AI TRADING<br />
                            <span className="text-metroll-primary">EVOLVED</span>
                        </h1>
                        ...
                        <p className="text-xl md:text-2xl text-zinc-400 max-w-xl mb-10 font-mono leading-relaxed">
                            ...
                            <span className="text-white font-bold ml-2 bg-metroll-accent px-2 py-0.5">DEGENERATES</span>.
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <button
                                onClick={handleScroll}
                                className="bg-metroll-primary text-black text-lg font-black px-8 py-4 uppercase tracking-wider hover:bg-white hover:scale-105 transition-all flex items-center gap-2 clip-path-slant"
                        ...
                        <div className="mt-12 flex items-center gap-8 text-zinc-500 font-mono text-xs md:text-sm">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-2 h-2 bg-metroll-accent rounded-full" />
                                VP v2.4.0
                            </div>
                        </div>
                    </motion.div>
                ...
                <div className="flex-1 relative flex items-end justify-center lg:justify-end overflow-hidden">
                    ...
                    <div className="absolute top-1/4 right-0 w-[600px] h-[600px] bg-metroll-accent/20 rounded-full blur-[100px] pointer-events-none" />
                    <div className="absolute bottom-0 left-10 w-[400px] h-[400px] bg-metroll-primary/10 rounded-full blur-[80px] pointer-events-none" />
