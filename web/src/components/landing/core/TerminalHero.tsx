...
export default function TerminalHero() {
    ...
    return (
        <section className="relative w-full min-h-screen bg-bg-surface-base text-text-content-primary overflow-hidden flex flex-col pt-20">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none">
                <div className="w-[80vw] h-[80vw] rounded-full border border-metroll-primary/20 animate-pulse-slow"></div>
                <div className="absolute w-[60vw] h-[60vw] rounded-full border border-dashed border-metroll-accent/20 animate-[spin_60s_linear_infinite]"></div>
            </div>

            {/* 3. Gradient Spots - Intensified for Mobile */}
            <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-metroll-primary/20 rounded-full blur-[120px] pointer-events-none mix-blend-screen"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vw] bg-metroll-accent/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen"></div>

            {/* Mobile Bottom Fade */}
            <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-bg-surface-base to-transparent z-20 pointer-events-none md:hidden" />
            ...
            <div className="md:hidden absolute top-24 left-4 z-0 opacity-40 pointer-events-none">
                <div className="w-24 h-24 border border-dashed border-metroll-primary/30 rounded-full animate-spin-slow flex items-center justify-center">
                    <div className="w-16 h-16 border border-metroll-accent/30 rounded-full"></div>
                </div>
            </div>
            ...
            <div className="relative z-10 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-8 max-w-[1800px] mx-auto w-full px-6 h-full pb-20 pt-10 pointer-events-none">
                ...
                <div className="hidden lg:flex col-span-3 flex-col justify-between h-full border-r border-white/5 pr-8 py-10 pointer-events-auto">
                    ...
                    <div className="space-y-6">
                        <div className="tech-border p-4 bg-black/40 backdrop-blur-sm">
                            <h3 className="text-xs font-mono text-metroll-primary mb-4 flex items-center gap-2">
                            ...
                            <div className="space-y-3 font-mono text-[10px] text-zinc-400">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-metroll-accent">12ms</span>
                                </div>
                                <div className="w-full h-1 bg-zinc-800 rounded-full overflow-hidden">
                                    <div className="w-[90%] h-full bg-metroll-accent/50"></div>
                                </div>
                        ...
                        <div className="p-4 border border-zinc-800/50 rounded bg-zinc-900/20">
                            ...
                            <div className="flex gap-1">
                                <div className="h-1 flex-1 bg-metroll-primary"></div>
                                <div className="h-1 flex-1 bg-metroll-primary"></div>
                                <div className="h-1 flex-1 bg-metroll-primary"></div>
                                <div className="h-1 flex-1 bg-zinc-800"></div>
                            </div>
                            <div className="mt-2 text-right text-[10px] text-metroll-primary/80 font-mono">LEVEL 3 ACTIVATE</div>
                        </div>
                    </div>
                ...
                <div className="col-span-1 lg:col-span-6 flex flex-col items-center justify-center text-center relative z-20 pointer-events-auto">
                    ...
                    <motion.div
                        ...
                        className="mb-8 inline-flex items-center gap-3 px-4 py-2 rounded-full border border-metroll-primary/20 bg-metroll-primary/5 backdrop-blur-md"
                    >
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-metroll-primary opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-metroll-primary"></span>
                        </span>
                        <span className="text-xs font-mono text-metroll-primary tracking-widest">NOFX OPEN-SOURCE AGENTIC OS</span>
                    </motion.div>
                    ...
                    <div className="relative z-20 mix-blend-hard-light md:mix-blend-normal">
                        <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter leading-[0.9] md:leading-[0.8] mb-6 select-none bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-zinc-600 drop-shadow-2xl">
                            AGENTIC<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-metroll-primary via-white to-metroll-primary animate-shimmer bg-[length:200%_auto] tracking-tight filter drop-shadow-[0_0_15px_rgba(234,179,8,0.3)]">TRADING</span>
                        </h1>
                    ...
                    <div className="flex flex-col gap-4 mb-14">
                        <div className="text-metroll-primary/80 font-mono text-xs tracking-[0.3em] uppercase flex items-center gap-2 ml-1">
                            <span className="relative flex h-2 w-2">
                        ...
                        <div className="flex flex-wrap gap-4 font-mono">
                            {['CRYPTO', 'US STOCKS', 'FOREX', 'METALS'].map((market) => (
                                <div key={market} className="relative group cursor-default">
                                    <div className="absolute -inset-0.5 bg-gradient-to-r from-metroll-primary/20 to-blue-600/20 rounded-lg blur opacity-0 group-hover:opacity-100 transition duration-500"></div>
                                    <div className="relative flex items-center gap-3 px-6 py-3 rounded-lg bg-zinc-900/80 border border-zinc-700 hover:border-metroll-primary/50 transition-all duration-300 backdrop-blur-sm">
                                        <div className="w-1.5 h-1.5 rounded-full bg-profit shadow-[0_0_8px_rgba(74,222,128,0.6)] animate-pulse"></div>
                                        <span className="text-lg md:text-xl font-bold text-white tracking-wider group-hover:text-metroll-primary transition-colors">{market}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="w-full max-w-lg h-12 bg-black/50 border border-zinc-800 rounded flex items-center px-4 mb-10 font-mono text-sm shadow-2xl backdrop-blur-sm group hover:border-metroll-primary/50 transition-colors cursor-text" onClick={() => document.getElementById('market-scanner')?.scrollIntoView({ behavior: 'smooth' })}>
                        <span className="text-profit mr-2">➜</span>
                        <span className="text-metroll-accent mr-2">~</span>
                        <span className="text-zinc-500">deploy agent --strategy=hft</span>
                        <span className="w-2 h-4 bg-metroll-primary ml-1 animate-pulse"></span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                        <button
                            ...
                            className="group relative overflow-hidden bg-metroll-primary text-black px-8 py-4 font-bold font-mono tracking-wider hover:scale-105 transition-transform duration-200"
                ...
                <div className="relative w-full h-full flex items-center justify-center perspective-1000">
                    ...
                    <div className="relative w-full h-[90%] flex items-center justify-center transform-style-3d rotate-y-[-12deg]">
                        ...
                        <div className="relative z-10 w-full h-full opacity-100 transition-all duration-500 group flex flex-col justify-end pointer-events-auto">
                            <div className="absolute inset-x-0 bottom-0 top-1/2 bg-metroll-accent/5 blur-[60px] rounded-full animate-pulse-slow transition-colors duration-500 group-hover:bg-metroll-primary/20"></div>
                            ...
                            <div className="absolute w-full h-1 bg-metroll-accent/30 drop-shadow-[0_0_10px_rgba(0,240,255,0.8)] top-0 animate-scan-fast pointer-events-none mix-blend-overlay"></div>
                    ...
                    <motion.div
                        ...
                        className="absolute top-[30%] left-[10%] bg-black/80 border border-metroll-accent/30 p-2 rounded backdrop-blur-md shadow-neon-blue hidden md:block"
                    >
                        <Cpu className="w-5 h-5 text-metroll-accent" />
                    </motion.div>

                    <motion.div
                        animate={{ y: [0, 10, 0] }}
                        transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                        className="absolute bottom-[20%] right-[20%] bg-black/80 border border-metroll-primary/30 p-2 rounded backdrop-blur-md shadow-neon hidden md:block"
                    >
                        <Lock className="w-5 h-5 text-metroll-primary" />
                    </motion.div>
            ...
            <div className="absolute bottom-0 w-full bg-black/80 border-t border-zinc-800/50 backdrop-blur-md z-30 overflow-hidden py-2 flex items-center">
                <div className="flex animate-marquee whitespace-nowrap gap-12 text-xs font-mono text-zinc-500 px-4">
                    ...
                    <span className="flex items-center gap-2 text-metroll-primary"><Zap className="w-3 h-3" /> FLASH LOANS ENABLED</span>
                    ...
                    <span className="flex items-center gap-2"><CircuitBoard className="w-3 h-3 text-metroll-accent" /> AI MODEL: GEMINI-PRO-1.5</span>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-4xl">
            {stats.map((stat, i) => (
                <a
                    ...
                    className="flex flex-col items-center justify-center p-3 rounded bg-black/40 border border-zinc-800/50 backdrop-blur-sm group hover:border-metroll-primary/30 transition-all cursor-pointer hover:bg-white/5"
                >
                    <div className="flex items-center gap-2 mb-1">
                        <stat.icon className={`w-4 h-4 ${stat.color}`} />
                        <span className="text-[10px] font-mono text-zinc-500 tracking-wider">{stat.label}</span>
                    </div>
                    <span className="text-xl font-bold font-mono text-white group-hover:text-metroll-primary transition-colors">{stat.value}</span>
                </a>
            ))}
        </div>
    )
