...
const agents = [
    {
        ...
        winRate: "68%",
        risk: "HIGH",
        color: "text-metroll-primary",
        border: "border-metroll-primary/50",
...
export default function AgentGrid() {
    ...
    return (
        <section id="market-scanner" className="py-16 md:py-24 bg-bg-surface-base relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-10 md:mb-16 gap-6">
                    <div>
                        <div className="flex items-center gap-2 text-metroll-primary font-mono text-xs mb-2 tracking-widest uppercase">
                            <Crosshair className="w-4 h-4" /> MARKET SELECT
                        </div>
                        <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter">
                            STRATEGY <span className="text-transparent bg-clip-text bg-gradient-to-r from-metroll-primary to-white">UNITS</span>
                        </h2>
                    </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="p-8 relative z-10">
                                    ...
                                    {/* Name & Desc */}
                                    <h3 className="text-3xl font-bold text-white mb-2 tracking-tight group-hover:text-metroll-accent transition-colors">{agent.name}</h3>
                                    ...
                                    <button
                                        ...
                                        className={`w-full py-4 text-xs font-bold font-mono uppercase tracking-[0.2em] border border-zinc-700 hover:border-${agent.color === 'text-metroll-primary' ? 'metroll-primary' : 'white'} hover:bg-white/5 transition-all flex items-center justify-center gap-2 group-hover:text-white cursor-pointer`}
                                    >
