            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-2 text-metroll-primary font-mono text-xs tracking-[0.2em] uppercase">
                            <Server className="w-4 h-4" /> System Deployment
                        </div>

                        <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">
                            DEPLOY <span className="text-transparent bg-clip-text bg-gradient-to-r from-metroll-primary to-white">INSTANTLY</span>
                        </h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                            {[
                                ...
                                <div key={i} className="flex gap-4 items-start p-4 rounded bg-zinc-900/50 border border-zinc-800 hover:border-metroll-primary/30 transition-colors group">
                                    <div className="p-2 rounded bg-black border border-zinc-800 text-metroll-primary group-hover:bg-metroll-primary/10 transition-colors">
                    ...
                    >
                        {/* Glow effect */}
                        <div className="absolute -inset-1 bg-gradient-to-r from-metroll-primary/20 to-blue-500/20 rounded-xl blur-xl opacity-50"></div>
                        ...
                        <div className="relative rounded-xl overflow-hidden bg-[#0a0a0a] border border-zinc-800 shadow-2xl">
                            ...
                            <div className="p-8 font-mono text-sm md:text-base bg-black/50 backdrop-blur-sm min-h-[200px] flex flex-col justify-center">
                                ...
                                <div
                                    className="group relative flex items-start gap-3 p-4 rounded-lg bg-zinc-900/50 border border-zinc-800 hover:border-metroll-primary/50 cursor-pointer transition-all hover:bg-zinc-900/80"
                                    onClick={handleCopy}
                                >
                                    <span className="text-metroll-primary mt-1"><ChevronRight className="w-4 h-4" /></span>
