      ...
      <div className="w-full max-w-lg relative z-10 px-6">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tighter text-white uppercase mb-2">
            <span className="text-metroll-primary">NEW_USER</span> ONBOARDING
          </h1>
              ...
              <form onSubmit={handleRegister} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 border border-zinc-700 rounded px-4 py-3 text-sm focus:border-metroll-primary focus:ring-1 focus:ring-metroll-primary/50 outline-none transition-all placeholder-zinc-800 text-white font-mono"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-black/50 border border-zinc-700 rounded px-4 py-3 text-sm focus:border-metroll-primary focus:ring-1 focus:ring-metroll-primary/50 outline-none transition-all placeholder-zinc-800 text-white font-mono pr-10"
                        placeholder="••••••••"
                        required
                      />
                      <button
                ...
                {betaMode && (
                  <div>
                    <label className="block text-xs uppercase tracking-wider text-metroll-primary mb-1.5 ml-1 font-bold">Priority Access Code</label>
                    <input
                      type="text"
                      value={betaCode}
                      onChange={(e) => setBetaCode(e.target.value.replace(/[^a-z0-9]/gi, '').toLowerCase())}
                      className="w-full bg-black/50 border border-zinc-700 rounded px-4 py-3 text-sm focus:border-metroll-primary focus:ring-1 focus:ring-metroll-primary/50 outline-none transition-all placeholder-zinc-800 text-white font-mono tracking-widest"
                      placeholder="XXXXXX"
                      maxLength={6}
                      required={betaMode}
                    />
                ...
                <div className="space-y-4 font-mono text-xs text-zinc-400 bg-black/20 p-4 rounded border border-zinc-800/50">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="mb-2">We highly recommend <span className="text-metroll-primary">Google Authenticator</span> for compatibility.</p>
                      <div className="flex gap-2">
                  ...
                  <div className="flex gap-3 items-start">
                    <span className="text-metroll-primary font-bold mt-0.5">03</span>
                    <div>
              ...
              <form onSubmit={handleOTPVerify} className="space-y-6">
                ...
                <div>
                  <input
                    ...
                    className="w-full bg-black border border-zinc-700 rounded px-4 py-4 text-center text-3xl tracking-[0.5em] font-mono text-white focus:border-metroll-primary focus:ring-1 focus:ring-metroll-primary/50 outline-none transition-all placeholder-zinc-800"
                    placeholder="000000"
                    maxLength={6}
                    required
                    autoFocus
                ...
                <button
                  ...
                  className="w-full bg-metroll-primary text-black font-bold py-3 px-4 rounded text-sm tracking-wide uppercase hover:bg-yellow-400 transition-colors font-mono shadow-lg disabled:opacity-50"
                >
