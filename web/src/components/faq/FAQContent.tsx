  ...
  return (
    <div className="space-y-12">
      {categories.map((category) => (
        <div key={category.id} className="card p-8 rounded-xl border border-white/5">
          {/* Category Header */}
          <div className="flex items-center gap-3 mb-6 pb-3 border-b border-white/10">
            <category.icon className="w-7 h-7 text-metroll-primary" />
            <h2 className="text-2xl font-bold text-text-content-primary">
          ...
          <div className="space-y-8">
            {category.items.map((item) => (
              ...
              >
                {/* Question */}
                <h3 className="text-xl font-semibold mb-3 text-text-content-primary">
                  {t(item.questionKey, language)}
                </h3>

                {/* Answer */}
                <div className="prose prose-invert max-w-none text-text-content-tertiary leading-relaxed">
                    ...
                    <div className="space-y-3">
                      <div className="text-base">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="text-metroll-primary hover:underline"
                        >
                          CONTRIBUTING.md
                        </a>
                        {'  |  '}
                      ...
                      <div className="rounded p-3 mt-3 bg-metroll-primary/10 border border-metroll-primary/25">
                        {language === 'zh' ? (
                          <div className="text-sm">
                            <strong className="text-metroll-primary">Note:</strong>{' '}
